...
3. ​	EXTI_InitStructure.EXTI_Line = EXTI_Line1;					//选择配置外部中断的14号线
4. ​	NVIC_InitStructure.NVIC_IRQChannel = EXTI1_IRQn;		//选择配置NVIC的EXTI15_10线
5. void EXTI1_IRQHandler(void)   //中断处理函数
