...
#define LCD_SCL        	GPIO_Pin_6	//PB13--->>TFT --SCL/SCK
#define LCD_SDA        	GPIO_Pin_7	//PB15 MOSI--->>TFT --SDA/DIN
#define LCD_RST     	GPIO_Pin_0	//PB10--->>TFT --RES
#define LCD_RS         	GPIO_Pin_1	//PB11--->>TFT --RS/DC
#define LCD_CS     	    GPIO_Pin_5	//PB10--->>TFT --RST
...
#define	No_FlipColor 		0x21  //不翻转颜色
#define	FlipColor			0x20  //翻转颜色 

#define	FrameRateControl 			0xB1  //帧速率控制（正常模式/全色）


#define	ControlScreenFlip			0x36  //控制屏幕翻转的  分别是C0/AO/00/60,对应着每次90度的翻转，
